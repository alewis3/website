...
class ProjectSection extends Component {
    render() {
        ...
        const JVMTBio = "Over the summer of 2019, Amanda embarked on a personal project to redo the vehicle simulator written in python for the We-Go project, except in java this time. The results are on her github, under her <a href='https://github.com/alewis3/Personal/tree/master/vehicleSimulatorJava'>Personal</a> repo.";
